...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _send(String text) async {
    ...
    try {
      ...
      setState(() { _msgs.add({'role': 'ai', 'content': 'Something went wrong. Please check your API key and try again.'}); _loading = false; });
    }
    _scrollBottom();
  }
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('Personal dermatologist', style: TextStyle(color: Color(0xFF555555), fontSize: 11)),
          ]),
        ]),
        actions: [
          IconButton(
        ...
        Expanded(
          child: _msgs.isEmpty ? _buildWelcome() : ListView.builder(
            ...
            itemBuilder: (_, i) {
              ...
              final m = _msgs[i];
              return _buildBubble(m['content']!, m['role'] == 'user');
            },
          ),
        ),
        _buildInput(),
  ...
  Widget _buildWelcome() {
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        const Text('Your AI dermatologist', style: TextStyle(color: Color(0xFFF0EDE6), fontSize: 18, fontWeight: FontWeight.w700)),
        const SizedBox(height: 6),
        const Text('Ask me anything about your skin, hair, or any product — I\'ll give you personalised advice.', textAlign: TextAlign.center, style: TextStyle(color: Color(0xFF555555), fontSize: 13, height: 1.5)),
        ...
        ..._suggestions.map((s) => GestureDetector(
          ...
          child: Container(
            ...
            child: Row(children: [
              Expanded(child: Text(s, style: const TextStyle(color: Color(0xFFD4B896), fontSize: 13))),
  ...
  Widget _dot(int delayMs) {
    return TweenAnimationBuilder<double>(
      ...
      builder: (_, v, __) => Container(
        width: 6, height: 6,
        decoration: BoxDecoration(
          color: Color.lerp(const Color(0xFF333333), const Color(0xFFC9A84C), v),
